...
STR8_IN65_VERSION := v1.35
STR8_IN65_VERSION_TEXT := 1.35
...
RELEASE_DEFINES := -DSTR8_V1_LAYOUT -DSTR8_V1_INSTALLER_DRY -DSTR8_V1_INSTALLER_TXN -DSTR8_IN65_COLD_BOOT -DSTR8_IN65_VERSION_135 -DSTR8_IN65_EDU_QUIET_START
...
LED_WORKER_TEST_SRC := tools/led-status-test/str8n-v1.35-led-worker-test-2000.asm
...
IRQ_TEST_SRC := tools/interrupt-test/str8n-v1.35-irq-test-2000.asm
IRQ_TEST_OBJ := $(OBJ_DIR)/str8n-$(VERSION)-irq-test-2000.obj
IRQ_TEST_S19 := $(S19_DIR)/str8n-$(VERSION)-irq-test-2000.s19
...
# Executes the linked resident and worker against the frozen v1.33 baseline.
# Requires py65==1.2.0; flash/console hardware are modeled, never contacted.
.PHONY: size-optimization-check
size-optimization-check: programmer-bin
	python tools/test_conservative_resident.py
...
# STR8-N v1.35 is the promoted STR8-iN/65 production image.
...
.PHONY: irq-test
irq-test: $(IRQ_TEST_S19)

.PHONY: board-probe-check
board-probe-check: irq-test led-worker-test
	python tools/test_irq_probe.py
	python tools/test_led_worker_probe.py

.PHONY: bank-maint-role-check
...
$(IRQ_TEST_OBJ): $(IRQ_TEST_SRC) | dirs
	...
	@if exist $(subst /,\,$(<:.asm=.lst)) move /Y $(subst /,\,$(<:.asm=.lst)) $(subst /,\,$(LST_DIR)/str8n-$(VERSION)-irq-test-2000.lst)
	@if exist $(subst /,\,$(<:.asm=.sym)) move /Y $(subst /,\,$(<:.asm=.sym)) $(subst /,\,$(SYM_DIR)/str8n-$(VERSION)-irq-test-2000.sym)

$(IRQ_TEST_S19): $(IRQ_TEST_OBJ) | dirs
...
$(BANK_MAINT_OBJ): $(BANK_MAINT_SRC) $(BANK_MAINT_RENAME_SRC) | dirs
	$(ASM) -G -L -S -W -I tools/bank-maint -DSTR8_BANK_MAINT_TOP=0 -DSTR8_IN65_BANK_MAINT=0 -DSTR8_IN65_VERSION_135=1 $<
	@if exist $(subst /,\,$(<:.asm=.obj)) move /Y $(subst /,\,$(<:.asm=.obj)) $(subst /,\,$@)
...
$(BANK_MAINT_MENU_OBJ): $(BANK_MAINT_MENU_SRC) $(BANK_MAINT_SRC) $(BANK_MAINT_RENAME_SRC) $(TOP_UPDATE_SRC) $(TOP_UPDATE_INC) | dirs
	$(ASM) -G -L -S -W -I tools/bank-maint -I tools/top-update -I $(RELEASE_DIR)/generated -DSTR8_IN65_BANK_MAINT=0 -DSTR8_IN65_VERSION_135=1 $<
	@if exist $(subst /,\,$(<:.asm=.obj)) move /Y $(subst /,\,$(<:.asm=.obj)) $(subst /,\,$@)
...
$(CONSOLE_ABI_TEST_OBJ): $(CONSOLE_ABI_TEST_SRC) $(SRC_DIR)/str8-console-eq.inc | dirs
	$(ASM) -G -L -S -W -I $(SRC_DIR) -DSTR8_IN65_VERSION_135=1 $<
	@if exist $(subst /,\,$(<:.asm=.obj)) move /Y $(subst /,\,$(<:.asm=.obj)) $(subst /,\,$@)
...
$(TOP_UPDATE_OBJ): $(TOP_UPDATE_SRC) $(TOP_UPDATE_INC) | dirs
	$(ASM) -G -L -S -W -I $(RELEASE_DIR)/generated -DSTR8_TOP_EMBED=0 -DSTR8_DIRECTORY_REFRESH=0 -DSTR8_IN65_VERSION_135=1 $<
	@if exist $(subst /,\,$(<:.asm=.obj)) move /Y $(subst /,\,$(<:.asm=.obj)) $(subst /,\,$@)
...
$(STR8_IN65_TOP_UPDATE_OBJ): $(TOP_UPDATE_SRC) $(STR8_IN65_TOP_UPDATE_INC) | dirs
	$(ASM) -G -L -S -W -I $(STR8_IN65_RELEASE_DIR)/generated -DSTR8_TOP_EMBED=0 -DSTR8_DIRECTORY_REFRESH=0 -DSTR8_IN65_TOP_IMAGE -DSTR8_IN65_VERSION_135 $<
	@if exist $(subst /,\,$(<:.asm=.obj)) move /Y $(subst /,\,$(<:.asm=.obj)) $(subst /,\,$@)
...
$(DIRECTORY_REFRESH_OBJ): $(TOP_UPDATE_SRC) $(TOP_UPDATE_INC) | dirs
	$(ASM) -G -L -S -W -I $(RELEASE_DIR)/generated -DSTR8_TOP_EMBED=0 -DSTR8_DIRECTORY_REFRESH=1 -DSTR8_IN65_VERSION_135=1 $<
	@if exist $(subst /,\,$(<:.asm=.obj)) move /Y $(subst /,\,$(<:.asm=.obj)) $(subst /,\,$@)
...
$(WDCMONV2_INSTALL_OBJ): $(WDCMONV2_INSTALL_SRC) $(WDCMONV2_INSTALL_INC) | dirs
	$(ASM) -G -L -S -W -I $(RELEASE_DIR)/generated -DSTR8_IN65_VERSION_135=1 $<
	@if exist $(subst /,\,$(<:.asm=.obj)) move /Y $(subst /,\,$(<:.asm=.obj)) $(subst /,\,$@)
...
$(STR8_IN65_INSTALL_OBJ): $(WDCMONV2_INSTALL_SRC) $(STR8_IN65_GENERATED_INC) | dirs
	$(ASM) -G -L -S -W -I $(STR8_IN65_RELEASE_DIR)/generated -DW2I_STR8_IN65_IMAGE -DSTR8_IN65_VERSION_135 $<
	@if exist $(subst /,\,$(<:.asm=.obj)) move /Y $(subst /,\,$(<:.asm=.obj)) $(subst /,\,$@)
...
$(STR8_IN65_STOCK_RESTORE_OBJ): $(WDCMONV2_INSTALL_SRC) | dirs
	$(ASM) -G -L -S -W -DW2I_RESTORE_STOCK=1 -DSTR8_IN65_VERSION_135=1 $<
	@if exist $(subst /,\,$(<:.asm=.obj)) move /Y $(subst /,\,$(<:.asm=.obj)) $(subst /,\,$@)
...
$(STR8_S19): $(STR8_OBJ) | dirs
	$(LINKER) $(STR8_LINKFLAGS) $@ $(STR8_OBJ)
	$(MOVE_LINK_SIDECARS)
...
$(STR8_IN65_S19): $(STR8_IN65_OBJ) | dirs
	$(LINKER) $(STR8_LINKFLAGS) $@ $(STR8_IN65_OBJ)
	$(MOVE_LINK_SIDECARS)
	@powershell -NoProfile -ExecutionPolicy Bypass -Command "$$p='$@'; $$lines=Get-Content -LiteralPath $$p; $$lines[-1]='S903F0000C'; Set-Content -LiteralPath $$p -Value $$lines"
...
help:
	...
	@echo make str8-in65-bank-maint - build the v1.35 interactive directory/search-flag RAM tool
	...
	@echo make release-package - build and verify the STR8-N v1.35-only release ZIP
