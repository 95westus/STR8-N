; STR8-N v1.34 RAM-worker LED hardware probe.
; Load with STR8-N L; S9 starts at $2000. The probe requires scratch sector
; B2:9 to be erased, programs and verifies a dense test pattern, then erases
; and verifies it with the production worker. B2:9 ends erased and the
...
; Independently verify the dense pattern, then erase/verify B2:9 back to its
...
; Compare the selected bank's CPU $9000-$9FFF with staged RAM $3000-$3FFF.
...
LWT_MSG_TITLE:          DB              $0D,$0A,"STR8-N LED WORKER TEST",$0D,$0A
                        DB              "TARGET B2:9 ERASED SCRATCH",$0D,$0A,0
LWT_MSG_CONFIRM:        DB              "TYPE Y TO PREFLIGHT B2:9> ",0
LWT_MSG_ABORT:          DB              $0D,$0A,"ABORT; NOTHING WRITTEN",$0D,$0A,0
LWT_MSG_ARMED:          DB              $0D,$0A,"LED $F0 PRE-ARMED; TYPE Y TO PROGRAM B2:9> ",0
LWT_MSG_PROGRAM:        DB              $0D,$0A,"PROGRAM/VERIFY $A5; WORKER OWNS $F0",$0D,$0A,0
LWT_MSG_RESTORE:        DB              "ERASE/VERIFY B2:9 BACK TO $FF",$0D,$0A,0
LWT_MSG_FAIL_CLOSED_PASS:
                        DB              "FAILED WRITE PREFLIGHT RETURN LED $01: PASS",$0D,$0A,0
LWT_MSG_PASS:           DB              "B2:9 ERASED; LED WORKER TEST: PASS",$0D,$0A
                        DB              "PRESS PHYSICAL RESET",$0D,$0A,0
LWT_MSG_COPY_FAIL:      DB              $0D,$0A,"WORKER COPY: FAIL",$0D,$0A,0
LWT_MSG_PREFLIGHT_FAIL: DB              $0D,$0A,"REFUSE: B2:9 NOT ERASED",$0D,$0A,0
LWT_MSG_WORKER_FAIL:    DB              $0D,$0A,"B2:9 PATTERN WORKER: FAIL",$0D,$0A,0
LWT_MSG_VERIFY_FAIL:    DB              $0D,$0A,"B2:9 PATTERN VERIFY: FAIL",$0D,$0A,0
LWT_MSG_RESTORE_FAIL:   DB              $0D,$0A,"B2:9 ERASE WORKER: FAIL",$0D,$0A,0
LWT_MSG_RESTORE_VERIFY_FAIL:
                        DB              $0D,$0A,"B2:9 ERASE VERIFY: FAIL",$0D,$0A,0
