...
TU_IN_READY:           LDA             #TU_FTDI_RXF
                        ...
                        IF              STR8_V2_TOP_IMAGE
TU_MSG_TITLE:          DB              $0D,$0A,"STR8-N 2.0a17 B3 INSTALL",$0D,$0A
                        ELSE
                        IF              STR8_DIRECTORY_REFRESH
...
TU_MSG_RECEIPT:        DB              "SAFE PHY $17000-$17FFF; TARGET PHY "
                        ...
                        IF              STR8_V2_TOP_IMAGE
TU_MSG_FINAL:          DB              "TYPE STR8-N 2.0a17> ",0
                        ELSE
                        IF              STR8_DIRECTORY_REFRESH
...
TU_MSG_RECOVERY:       DB              "WRITE FAIL: R=RETRY O=RESTORE OLD> ",0
                        IF              STR8_V2_TOP_IMAGE
TU_MSG_OK:             DB              "STR8-N 2.0a17 VERIFIED; RESET",$0D,$0A,0
                        ELSE
                        IF              STR8_DIRECTORY_REFRESH
...
TU_CONFIRM_BACKUP:     DB              "BACKUP B2F",0
                        IF              STR8_V2_TOP_IMAGE
TU_CONFIRM_FINAL:      DB              "STR8-N 2.0A17",0
                        ELSE
                        IF              STR8_DIRECTORY_REFRESH
...
TU_CANDIDATE_IMAGE:
                        IF              STR8_V2_TOP_IMAGE
                        INCLUDE         "str8n-v2-alpha17-top-image.inc"
                        ELSE
