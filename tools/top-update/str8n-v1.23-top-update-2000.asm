; STR8-N v1.23 BANK-3 TOP-SECTOR UPDATE / DIRECTORY REFRESH TOOL.
; Load with an installed STR8-N v1.1/v1.2/v1.21 L command; S9 starts at $2000.
; The exact host-verified v1.23 top-sector BIN is generated into the $4000 image.
...
TU_IN_READY:           LDA             #TU_FTDI_RXF
                        ...
                        IF              STR8_DIRECTORY_REFRESH
TU_MSG_TITLE:          DB              $0D,$0A,"STR8-N 1.23 DIRECTORY REFRESH",$0D,$0A
                        ELSE
