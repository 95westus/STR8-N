; STR8-N v1.28 BANK-3 TOP-SECTOR UPDATE / DIRECTORY REFRESH TOOL.
; Load with an installed STR8-N v1.1/v1.2/v1.21 L command; S9 starts at $2000.
; The exact host-verified v1.28 top-sector BIN is generated into the $4000 image.
...
TU_IN_READY:           LDA             #TU_FTDI_RXF
                        ...
                        IF              STR8_DIRECTORY_REFRESH
TU_MSG_TITLE:          DB              $0D,$0A,"STR8-N 1.28 DIRECTORY REFRESH",$0D,$0A
                        ELSE
                        IF              STR8_IN65_VERSION_128
TU_MSG_TITLE:          DB              $0D,$0A,"STR8-N 1.28 TOP UPDATE",$0D,$0A
                        ELSE
...
TU_MSG_FINAL:          DB              "TYPE ERASE DIRECTORY> ",0
                        ELSE
                        IF              STR8_IN65_VERSION_128
TU_MSG_FINAL:          DB              "TYPE STR8-N 1.28> ",0
                        ELSE
...
TU_MSG_OK:             DB              "DIRECTORY EMPTY; STR8-N VERIFIED; RESET",$0D,$0A,0
                        ELSE
                        IF              STR8_IN65_VERSION_128
TU_MSG_OK:             DB              "STR8-N 1.28 VERIFIED; RESET",$0D,$0A,0
                        ELSE
...
TU_CONFIRM_FINAL:      DB              "ERASE DIRECTORY",0
                        ELSE
                        IF              STR8_IN65_VERSION_128
TU_CONFIRM_FINAL:      DB              "STR8-N 1.28",0
                        ELSE
...
TU_CANDIDATE_IMAGE:
                        ...
                        IF              STR8_IN65_VERSION_128
                        INCLUDE         "str8n-v1.28-str8-in65-top-image.inc"
                        ELSE
                        INCLUDE         "str8n-v1.23-str8-in65-top-image.inc"
                        ENDIF
                        ELSE
                        IF              STR8_IN65_VERSION_128
                        INCLUDE         "str8n-v1.28-top-image.inc"
                        ELSE
