param(
    [string]$S19Path = "BUILD/v1.34/s19/str8n-v1.34-bank-maint-menu-2000.s19",
    [string]$OutPath = "tools/bank-maint/str8n-v1.34-bank-maint-menu-2000.a"
)
...
$lines.Add(';   G 2000')
$lines.Add(';')
$lines.Add('; N RENAMES ONE COMPLETE D0-D3 DESCRIPTION THROUGH A VERIFIED SCRATCH BACKUP.')
$lines.Add('; U RUNS THE GUARDED B3:F UPDATE WITH A VERIFIED B2:F BACKUP.')
$lines.Add('; P AP INPUT=$7000; EMBEDDED TOP=$4000.')
