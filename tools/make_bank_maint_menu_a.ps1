param(
    [string]$S19Path = "BUILD/v1.23/s19/str8n-v1.23-bank-maint-menu-2000.s19",
    [string]$OutPath = "tools/bank-maint/str8n-v1.23-bank-maint-menu-2000.a"
)
...
$lines.Add('; STR8N-V1.23-BANK-MAINT-MENU-2000.A')
