param(
    [string]$BinPath = "BUILD/v1.22/bin/str8n-v1.22-bank3-f000-ffff.bin",
    [string]$OutPath = "BUILD/v1.22/generated/str8n-v1.22-top-image.inc"
)
...
$identity = [System.Text.Encoding]::ASCII.GetBytes('STR8-N 1.22')
$found = $false
...
if (-not $found) { throw 'Candidate top BIN does not contain STR8-N 1.22 identity' }
