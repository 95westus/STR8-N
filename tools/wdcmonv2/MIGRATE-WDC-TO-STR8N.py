...
def main() -> int:
    ...
    try:
        ...
        print("Factory WDCMONv2 -> STR8-N 1.35")
        ...
        print("Confirmations: COPY B3 TO B0, then INSTALL STR8-N 1.35.")
        ...
        if args.details:
            ...
            print("  D0 is written only in the Bank-3 directory after verified v1.35 boot.")
        ...
        print("STR8-N 1.35 must appear; require D0 FF WDCV2 FFFF FCFFFFFF.")
