...
def main() -> int:
    ...
    try:
        ...
        print("Factory WDCMONv2 -> STR8-N 1.32")
        ...
        print("Confirmations: COPY B3 TO B0, then INSTALL STR8-N 1.32.")
        ...
        if args.details:
            ...
            print("  D0 is written only in the Bank-3 directory after verified v1.32 boot.")
        ...
        print("STR8-N 1.32 must appear; require D0 FF WDCV2 FFFF FCFFFFFF.")
