...
$readme = @(
    ...
    '  Windows 10/11 with Windows PowerShell 5.1 (powershell.exe).',
    '  Run from an interactive PowerShell console or Windows Terminal.',
    '  Install the board/interface USB virtual COM-port driver if needed.',
    '  Extract this ZIP to a writable local folder; do not run it inside the ZIP.',
    '  Close WDCDB, terminals, and serial monitors so the COM port is free.',
    '  Keep stable USB power and access to the board physical RESET button.',
    '  No Git, Python, make, WDC tools, WDCDB, internet, or T48 is required.',
    '  Administrator rights are normally needed only to install the COM driver.',
    '',
    'Optional preflight:',
