...
$expected = @(
    ...
    'PACKAGE-README.txt',
    'SOURCE/str8n-v1.33-wdcmonv2-install-image.inc',
...
if ($manifest.hardwareStatus -ne 'v1.33 artifact host-qualified; v1.32 factory migration board-accepted on SXB2 HW 3.00 WDCMON 2.00 BF/B5 flash, COM4, 2026-09-08') {
    throw 'Manifest must distinguish v1.33 host qualification from the v1.32 factory-migration board proof'
}
...
Write-Host 'V1.33 ARTIFACT = HOST-QUALIFIED; V1.32 FACTORY MIGRATION = BOARD-ACCEPTED'
