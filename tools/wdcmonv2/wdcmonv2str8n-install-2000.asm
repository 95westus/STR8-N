...
W2I_MSG_TITLE:          DB              $0D,$0A,"WDCMONV2 -> STR8-N 1.30 MIGRATION",$0D,$0A
                        DB              "B3 STOCK -> B0; STR8-N 1.30 -> B3:F",$0D,$0A
...
W2I_MSG_INSTALL_CONFIRM: DB             "TYPE INSTALL STR8-N 1.30> ",0
...
W2I_MSG_ABORT:          DB              "HALTED IN RAM; PHYSICAL RESET SELECTS B3",$0D,$0A,0
                        ...
                        IF              W2I_RESTORE_STOCK
W2R_MSG_TITLE:          DB              $0D,$0A,"STR8-N 1.30 STOCK RESTORE",$0D,$0A
...
W2I_TOKEN_INSTALL:      DB              "INSTALL STR8-N 1.30",0
...
W2R_RESET_HI:           DB              $00
                        ...
                        INCLUDE         "str8n-v1.30-str8-in65-test-image.inc"
                        ELSE
                        INCLUDE         "str8n-v1.23-str8-in65-test-image.inc"
                        ENDIF
                        ELSE
                        IF              STR8_IN65_VERSION_130
                        INCLUDE         "str8n-v1.30-wdcmonv2-install-image.inc"
                        ELSE
