...
Write-Host 'Factory WDCMONv2 -> STR8-N 1.35'
Write-Host ''
...
Write-Host 'Confirmations: COPY B3 TO B0, then INSTALL STR8-N 1.35.'
...
if ($Details) {
    ...
    Write-Host '  D0 is written only in the Bank-3 directory after verified v1.35 boot.'
...
Write-Host 'Press physical RESET: STR8-N 1.35 must appear.'
