param(
    ...
    [string]$OutPath = 'BUILD/v1.34/generated/str8n-v1.34-wdcmonv2-install-image.inc',
    [string]$CandidateBinPath = 'BUILD/v1.34/bin/str8n-v1.34-wdcmonv2-bank3-f000-ffff.bin'
)
