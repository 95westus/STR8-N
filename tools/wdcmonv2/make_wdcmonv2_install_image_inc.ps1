param(
    ...
    [string]$OutPath = 'BUILD/v1.32/generated/str8n-v1.32-wdcmonv2-install-image.inc',
    [string]$CandidateBinPath = 'BUILD/v1.32/bin/str8n-v1.32-wdcmonv2-bank3-f000-ffff.bin'
)
