param(
    ...
    [string]$OutPath = 'BUILD/v1.35/generated/str8n-v1.35-wdcmonv2-install-image.inc',
    [string]$CandidateBinPath = 'BUILD/v1.35/bin/str8n-v1.35-wdcmonv2-bank3-f000-ffff.bin'
)
