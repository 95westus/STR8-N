param(
    ...
    [string]$Str8S19Path = "BUILD/v1.35/s19/str8n-v1.35-f000.s19",
    ...
    [string]$BinPath = "BUILD/v1.35/bin/str8n-v1.35-bank3-f000-ffff.bin"
)
...
Set-ImageByte -Image $image -Address 0xFFF0 -Value 0xFF -Source 'No flash WORK sector'
Set-ImageByte -Image $image -Address 0xFFF1 -Value 0x2F -Source 'B2:F protected B3:F backup locator'
...
Write-Host ('SECTOR ROLES        = $FFF0=$FF no WORK; $FFF1=$2F B2:F B3:F backup; $FFF2-$FFF9 all FF')
