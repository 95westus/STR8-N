param(
    ...
    [string]$S19Path = 'BUILD/v1.32/s19/str8n-v1.32-str8-in65-factory-restore-2000.s19',
    [string]$MapPath = 'BUILD/v1.32/map/str8n-v1.32-str8-in65-factory-restore-2000.map',
