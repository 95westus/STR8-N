param(
    ...
    [string]$ConsoleAbiTestMapPath = "BUILD/v1.31/map/str8n-v1.31-console-abi-test-2000.map",
    ...
    [string]$BankMaintS19Path = "BUILD/v1.31/s19/str8n-v1.31-bank-maint-2000.s19",
    [string]$ConsoleAbiTestS19Path = "BUILD/v1.31/s19/str8n-v1.31-console-abi-test-2000.s19",
    [string]$TopUpdateS19Path = "BUILD/v1.31/s19/str8n-v1.31-top-update-2000.s19",
    [string]$DirectoryRefreshS19Path = "BUILD/v1.31/s19/str8n-v1.31-directory-refresh-2000.s19",
    [string]$Wdcmonv2ArchiveMapPath = "BUILD/v1.31/map/str8n-v1.31-wdcmonv2-archive-2000.map",
    [string]$Wdcmonv2ArchiveS19Path = "BUILD/v1.31/s19/str8n-v1.31-wdcmonv2-archive-2000.s19",
    [string]$Wdcmonv2InstallMapPath = "BUILD/v1.31/map/str8n-v1.31-wdcmonv2-install-2000.map",
    [string]$Wdcmonv2InstallS19Path = "BUILD/v1.31/s19/str8n-v1.31-wdcmonv2-install-2000.s19",
    [string]$Wdcmonv2InstallTopBinPath = "BUILD/v1.31/bin/str8n-v1.31-bank3-f000-ffff.bin",
    [string]$PublicContractPath = "BUILD/v1.31/include/str8n-public.inc",
...
$manifest = [ordered]@{
    ...
    artifacts = [ordered]@{
        topSector = [ordered]@{
            file = 'BUILD/v1.31/bin/str8n-v1.31-bank3-f000-ffff.bin'
            size = $top.Length
            cpuStart = 'F000'
            cpuEnd = 'FFFF'
            sha256 = (Get-FileHash -Algorithm SHA256 -LiteralPath $TopBinPath).Hash
            hardwareStatus = 'v1.31 guarded update and private $07 RX / $0B TX activity passed on COM4; public I/O remains LED-neutral; 2026-09-06'
            validationReport = 'docs/LED_IO_ACTIVITY_BOARD_TEST_2026-09-06.md'
        }
        workerS19 = [ordered]@{
            file = 'BUILD/v1.31/s19/str8n-v1.31-worker-0200.s19'
        ...
        bankMaintenanceS19 = [ordered]@{
            file = 'BUILD/v1.31/s19/str8n-v1.31-bank-maint-2000.s19'
            ramStart = '2000'
            ramEnd = '39B2'
            entry = '2000'
        ...
        consoleAbiTestS19 = [ordered]@{
            file = 'BUILD/v1.31/s19/str8n-v1.31-console-abi-test-2000.s19'
        ...
        topUpdateS19 = [ordered]@{
            file = 'BUILD/v1.31/s19/str8n-v1.31-top-update-2000.s19'
            ramStart = '2000'
            ramEnd = '4FFF'
            candidateStart = '4000'
            candidateEnd = '4FFF'
            ...
            hardwareEvidence = 'docs/LED_IO_ACTIVITY_BOARD_TEST_2026-09-06.md: guarded v1.31 install/verify and focused $07/$0B activity observations; COM4, 2026-09-06'
        ...
        directoryRefreshS19 = [ordered]@{
            file = 'BUILD/v1.31/s19/str8n-v1.31-directory-refresh-2000.s19'
            ramStart = '2000'
            ramEnd = '4FFF'
            candidateStart = '4000'
            candidateEnd = '4FFF'
        ...
        wdcmonv2ArchiveS19 = [ordered]@{
            file = 'BUILD/v1.31/s19/str8n-v1.31-wdcmonv2-archive-2000.s19'
        ...
        wdcmonv2InstallS19 = [ordered]@{
            file = 'BUILD/v1.31/s19/str8n-v1.31-wdcmonv2-install-2000.s19'
            ...
            hardwareStatus = 'v1.31 host-verified; factory migration hardware proof operator-deferred'
            candidateTopBin = 'BUILD/v1.31/bin/str8n-v1.31-bank3-f000-ffff.bin'
        ...
        publicContract = [ordered]@{
            file = 'BUILD/v1.31/include/str8n-public.inc'
