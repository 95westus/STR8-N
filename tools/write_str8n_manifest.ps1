param(
    ...
    [string]$ConsoleAbiTestMapPath = "BUILD/v1.29/s19/str8n-v1.29-console-abi-test-2000.map",
    ...
    [string]$Wdcmonv2ArchiveMapPath = "BUILD/v1.29/s19/str8n-v1.29-wdcmonv2-archive-2000.map",
    [string]$Wdcmonv2ArchiveS19Path = "BUILD/v1.29/s19/str8n-v1.29-wdcmonv2-archive-2000.s19",
    [string]$Wdcmonv2InstallMapPath = "BUILD/v1.29/s19/str8n-v1.29-wdcmonv2-install-2000.map",
