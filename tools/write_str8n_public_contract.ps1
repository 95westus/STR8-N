param(
    ...
    [string]$OutPath = "BUILD/v1.34/include/str8n-public.inc"
)
...
$groups = @(
    [ordered]@{
        ...
        Names = @(
            ...
            'STR8_CONFIG_FNV_POLICY', 'STR8_CONFIG_FNV_DEFAULT'
        )
    },
    [ordered]@{
    ...
    [ordered]@{
        ...
        Names = @(
            ...
            'STR8_REC_CAP_BUFFER', 'STR8_REC_CAP_CONSOLE',
            'STR8_REC_CAPS_V2',
            'STR8_REC_OP', 'STR8_REC_FORMAT', 'STR8_REC_SOURCE',
            'STR8_REC_STATUS', 'STR8_REC_SRC_LO', 'STR8_REC_SRC_HI',
            'STR8_REC_SRC_LEN', 'STR8_REC_KIND', 'STR8_REC_FLAGS',
            'STR8_REC_ADDR_LO', 'STR8_REC_ADDR_HI',
            'STR8_REC_DATA_LEN', 'STR8_REC_ENTRY_LO',
            'STR8_REC_ENTRY_HI', 'STR8_REC_DATA_LO',
            'STR8_REC_DATA_HI', 'STR8_REC_FAIL_LO',
            'STR8_REC_FAIL_HI', 'STR8_REC_OBSERVED',
            'STR8_REC_EXPECTED',
            'STR8_REC_DATA_BUF', 'STR8_REC_DATA_BUF_LO',
            'STR8_REC_DATA_BUF_HI', 'STR8_REC_DATA_MAX',
            'STR8_REC_OP_PARSE', 'STR8_REC_FORMAT_S19',
            'STR8_REC_SOURCE_BUFFER', 'STR8_REC_SOURCE_CONSOLE',
            'STR8_REC_KIND_NONE', 'STR8_REC_KIND_METADATA',
            'STR8_REC_KIND_DATA', 'STR8_REC_KIND_END',
            'STR8_REC_FLAG_ENTRY_VALID',
            'STR8_REC_OK', 'STR8_REC_BAD_OP', 'STR8_REC_BAD_FORMAT',
            'STR8_REC_BAD_SOURCE', 'STR8_REC_BAD_START',
            'STR8_REC_BAD_TYPE', 'STR8_REC_BAD_HEX',
            'STR8_REC_BAD_COUNT', 'STR8_REC_BAD_CHECKSUM',
            'STR8_REC_BAD_END', 'STR8_REC_ABORT'
        )
    },
    [ordered]@{
