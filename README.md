...
On the `v2` branch, alpha15 detects W65C02/W65C816, exports CPU and console
state through `BOARD_QUERY` at `$F02B`, and selects either the primary FT245 or
backup W65C51N console at initialization. Its concise EDU LED contract shows
running, flash-safety, and application-handoff states without spending
resident bytes on per-character animation. Board 2205 now boots alpha15 from
Bank 3, retains WDCMONv2 in Bank 0 and R-YORS/HIMON in Bank 1, and has a fully
erased Bank 2. Its V2-to-V2 guarded update and concise LED contract ran live
over COM3; see the
[alpha15 board test](docs/STR8N_V2_ALPHA15_LEAN_LED_BOARD_TEST_2026-09-23.md).
...
The alpha15 build and host regression suites pass. It also emits a RAM-only
