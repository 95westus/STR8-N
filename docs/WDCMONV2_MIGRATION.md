...
The production STR8-iN/65 v1.34 RAM menu, its B0 adoption defaults, and the exact
...
The v1.34 RAM migration and factory-restore tools force the EDU buzzer inactive,
