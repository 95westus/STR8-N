...
The alpha14 build emits
`BUILD/v2-alpha14/str8n-v2-alpha14-native-probe-2000.s19`. It is a 479-byte,
...
Start alpha14 on a W65C816 board and confirm this header:

```text
STR8-N 2.0a14 Bn 65C816
