...
The alpha12 build emits
`BUILD/v2-alpha12/str8n-v2-alpha12-native-probe-2000.s19`. It is a 479-byte,
...
Start alpha12 on a W65C816 board and confirm this header:
