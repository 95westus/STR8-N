...
`BUILD/v1.32/s19/str8n-v1.32-worker-0200.s19` is build and integration evidence, not a file
to send to `I`.
...
powershell -NoProfile -ExecutionPolicy Bypass `
  ...
  -EntryAddress 49152 `
  -Bank 3 `
  -S19Path BUILD/v1.32/s19/himon-bank3-c000-efff.s19
```
...
### STR8-N 1.32 bank-maintenance RAM image

`make bank-maint` builds and validates
`BUILD/v1.32/s19/str8n-v1.32-bank-maint-2000.s19`. Its S9 entry is `$2000`; the S1
...
`str8n-v1.32-directory-refresh-2000.s19` contain an all-`$FF` directory and
...
STR8-N v1.32 itself makes no fixed runtime allocation in `$1A00-$1FFF`.
...
The generated `BUILD/v1.32/include/str8n-public.inc` exports this complete
...
These host fixtures are written below `BUILD/v1.32/test/range-matrix`; they do not
...
BUILD/v1.32/s19/str8n-v1.32-f000.s19         resident build component
BUILD/v1.32/s19/str8n-v1.32-worker-0200.s19  worker evidence/build component
...
BUILD/v1.32/s19/str8n-v1.32-led-worker-test-2000.s19
...
BUILD/v1.32/bin/str8n-v1.32-wdcmonv2-bank3-f000-ffff.bin
                                      migration top: D0 WDCM2; roles FF/FF
BUILD/v1.32/str8n-v1.32-wdcmonv2-str8n-migration-kit.zip
                                      allowlisted consumer migration kit
BUILD/v1.32/s19/ryors-v1.2-str8n-himon-asm-bank0-2-8-f.s19
...
root `BUILD/v1.32/`. The compatibility manifest remains at
